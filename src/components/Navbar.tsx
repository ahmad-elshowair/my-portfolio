        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="flex items-center justify-between h-20">
            ...
            <button
              ...
              className="p-2 text-mainGreen hover:text-beige relative z-50 h-16 w-16"
            >
            ...
            {["me", "experience", "showcase", "contact"].map((section, i) => (
              ...
              >
                ...
                <Link
                  ...
                  className="text-4xl text-beige hover:text-green-500 transition-all duration-300 capitalize block px-4"
                >
                  {section}
                </Link>
