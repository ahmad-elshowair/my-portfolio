...
const Hero = () => {
  return (
    ...
    >
      ...
      <span className="absolute top-[6%] -left-[5%] w-[300px] h-[300px] rounded-full bg-mainGreen opacity-20 blur-[20px] -z-10" />

      {/* BACKGROUND DROP BUTTON*/}
      <span className="absolute bottom-[10%] -right-[2%] w-[200px] h-[200px] rounded-full bg-mainGreen opacity-20 blur-[20px] -z-10" />
      ...
      <article className="flex flex-col">
        <p className="text-lg md:text-xl text-mainGreen mt-12 self-start  tracking-wide z-10">
        ...
        <Link
          ...
          className="flex items-center self-end bg-green-500 text-beige px-8 py-3 rounded-2xl  font-semibold mt-20 hover:text-bgGreen hover:bg-green-600 hover:scale-125 transition-all duration-300 ease-in-out gap-2"
        >
          resume
          <FiDownloadCloud />
        </Link>
